        ...
        internal static double Get(List<Metar> metars, AverageValueType averageValueType) =>
            averageValueType switch
            {
                ...
                AverageValueType.TemperatureCelsius
                  => AverageTempDewpoint.Get(metars, true, true, null),

                AverageValueType.TemperatureFahrenheit
                  => AverageTempDewpoint.Get(metars, false, true, null),

                AverageValueType.DewpointCelsius
                  => AverageTempDewpoint.Get(metars, true, false, null),

                AverageValueType.DewpointFahrenheit
                  => AverageTempDewpoint.Get(metars, false, false, null),
                ...
                AverageValueType.WindGustStrength
                  => AverageWind.Get(metars, WindType.GustStrength, null),
