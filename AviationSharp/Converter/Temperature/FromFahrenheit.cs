namespace AviationSharp.Converter.Temperature
{
    public static class ConvertFromFahrenheit
    {
        ...
        public static decimal ToCelsius(this double value, int decimalPlaces) => Math.Round(((decimal)value - 32) * 5 / 9, decimalPlaces);
        ...
        public static decimal ToKelvin(this double value, int decimalPlaces) => Math.Round(((decimal)value - 32) * 5 / 9 + (decimal)273.15, decimalPlaces);
    }
}
